...
from WordCloud.visualize import *

conf = SparkConf().setAppName("bilibiliComment").setMaster("local")
...
def wordcount(stopWordPath, answersPath, isvisualize=True):
    """
    对所有答案进行
    ...
    """
    # 读取停用词表
    stopwords = getStopWords(stopWordPath)

    # 结巴分词
    words_list = jiebaCut(answersPath)
...
if __name__ == '__main__':
    ...
    answersPath = 'bilibili_comment.txt'
    wordcount(stopWordPath,answersPath)
    # print(getStopWords(stopWordPath))
    # print(jiebaCut(answersPath))
