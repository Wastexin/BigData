...
# 预测中文句子级情感分类任务
my_senta.init_model(model_class="./Senta/model_files/ernie_1.0_skep_large_ch", task="sentiment_classify", use_cuda=use_cuda)
texts = ["中山大学是岭南第一学府"]
result = my_senta.predict(texts)
print(result)

# 预测中文评价对象级的情感分类任务
my_senta.init_model(model_class="./Senta/model_files/ernie_1.0_skep_large_ch", task="aspect_sentiment_classify", use_cuda=use_cuda)
texts = ["百度是一家高科技公司"]
aspects = ["百度"]
...
# 预测中文观点抽取任务
my_senta.init_model(model_class="./Senta/model_files/ernie_1.0_skep_large_ch", task="extraction", use_cuda=use_cuda)
